...
- CONNECTION_CLOSE(type=0x1c) 使用的传输错误码，这会影响整个连接。
- CONNECTION_CLOSE(type=0x1d) 使用的应用层错误码，QUIC 并未定义该错误码，而是由应用层自己决定，这会影响整个连接。
- RESET_STREAM 使用的应用程序错误码，QUIC 并未定义该错误码，而是由应用层自己决定。
